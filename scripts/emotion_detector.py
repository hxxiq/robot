...
def generate_offline_response(user_input, emotion):
    responses = {
        ...
        "Disgust": [
            ...
            "Maybe a change of scenery or a favorite song can help reset your mood."
        ],
        "Neutral": [
...
def offer_supportive_activity():
    question = "Would you like to do a relaxing activity, like breathing or meditation?"
    print("🤖 Asking:", question)
    os.system(f'espeak "{question}"')
    ...
    try:
        ...
        print(f"🗣️ User replied: {reply}")

        if "yes" in reply:
            demonstrate_activity()
        else:
            print("🛑 User declined the activity.")
    except:
        print("⚠️ Couldn't understand user's response.")


def demonstrate_activity():
    print("🧘 Guiding a simple breathing exercise...")
    instructions = [
        "Let's begin a short breathing exercise.",
        "Breathe in... two... three...",
        "Hold it... two... three...",
        "And breathe out... two... three...",
        "Again. Inhale... two... three...",
        "Hold... two... three...",
        "Exhale... two... three...",
        "Good job. I hope you feel a bit more relaxed now."
    ]
    for line in instructions:
        os.system(f'espeak "{line}"')
        time.sleep(2)
